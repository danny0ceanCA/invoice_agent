                      ...
                      {isApproved ? (
                        ...
                        <>
                          <button
                            ...
                            className="rounded-lg border border-emerald-500 bg-emerald-50 px-3 py-2 text-sm font-semibold text-emerald-700 transition hover:bg-emerald-100 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
                            disabled={isBusy}
                          ...
                          <button
                            ...
                            className="rounded-lg border border-red-500 bg-red-50 px-3 py-2 text-sm font-semibold text-red-700 transition hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
                            disabled={isBusy}
