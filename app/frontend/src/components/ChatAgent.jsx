...
function ChatAgent({ districtKey }) {
  ...
  return (
    <div className="w-full flex flex-col bg-white">
      ...
      <div className="border-t border-slate-200 p-4 bg-white min-w-0">
        <div className="flex items-center gap-3">
          ...
          <form onSubmit={handleSend} className="flex flex-1 items-center gap-3">
            ...
            <button
              ...
              className="
                ...
                px-5 py-[0.95rem]
                rounded-xl text-[0.9rem] font-semibold
          ...
          {/* HOME BUTTON MATCH HEIGHT */}
          <Link
            to="/"
            className="
              inline-flex items-center rounded-xl border border-slate-300
              px-5 py-[0.95rem]
              text-[0.9rem] font-medium text-slate-700 shadow-sm
